      ...
      <main className="flex-1 p-4 md:p-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
          ...
          <div className="max-w-2xl space-y-6">
            {[
              { label: 'Company Name', value: 'SDV EDUTECH' },
              { label: 'Admin Email', value: 'admin@sdvedutech.com' },
              { label: 'Support Email', value: 'support@sdvedutech.com' },
              ...
              >
                <label className="block text-sm font-semibold text-foreground mb-2">{setting.label}</label>
                <input
                  type="text"
                  value={setting.value}
                  readOnly
