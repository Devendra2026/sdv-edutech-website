...
export default function PageHero({
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 blueprint-grid opacity-60 [mask-image:radial-gradient(120%_80%_at_50%_0%,#000_30%,transparent_75%)]" aria-hidden />

      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 pt-12 md:pt-16 pb-14 md:pb-20">
        <motion.div
          className={`grid gap-12 items-center ${
            visual && !centered ? 'lg:grid-cols-2' : 'grid-cols-1'
          }`}
          variants={container}
          initial="hidden"
          animate="visible"
