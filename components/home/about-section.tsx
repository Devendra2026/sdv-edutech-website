        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-lg text-gray-600 leading-relaxed">
              Sdv Edutech Private Limited is your trusted partner for integrated digital and
              technology solutions, delivering end-to-end services across
              AI-enabled IT systems, GIS & smart surveying, intelligent data
              digitization, project consultancy, and capacity building.
            </p>

            <p className="mt-4 text-lg text-gray-600 leading-relaxed">
              We collaborate closely with government bodies and corporate
              organizations to design and deploy scalable, secure, and
              high-performance solutions.
            </p>

            <p className="mt-4 text-lg text-gray-600 leading-relaxed">
              By combining advanced technologies, industry expertise, and a
              skilled workforce, we empower organizations to improve data
              accuracy, optimize operations, and achieve sustainable growth.
            </p>
          </div>
        ...
        <div className="mt-24 grid gap-8 md:grid-cols-3">
          ...
          >
            ...
            <p className="mt-3 text-gray-600 leading-relaxed">
              Recognized as a registered MSME, ensuring compliance,
              credibility, and quality-driven service delivery.
            </p>
          </div>
          ...
          >
            ...
            <p className="mt-3 text-gray-600 leading-relaxed">
              Extensive service coverage across India with experience in
              government, corporate, and institutional projects.
            </p>
          </div>
          ...
          >
            ...
            <p className="mt-3 text-gray-600 leading-relaxed">
              Supported by highly skilled professionals delivering reliable,
