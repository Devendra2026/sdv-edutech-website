    ...
    <section className="relative overflow-hidden py-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="mt-5 text-4xl md:text-5xl font-bold text-blue-900">
            Our Recognition
          </h2>
       

          <p className="mt-5 text-lg text-gray-600 max-w-3xl mx-auto">
            We take pride in our achievements and recognitions received
            for excellence, compliance, and quality service delivery.
          </p>
