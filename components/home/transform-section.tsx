...
export default function TransformSection() {
  const items: TransformItem[] = [
    { icon: <TrendingUp className="w-6 h-6" />, title: 'Scalable Solutions', description: 'Build systems that grow with your business needs and market demands.' },
    { icon: <Users className="w-6 h-6" />, title: 'Expert Team', description: 'Access a team of industry-leading professionals with proven expertise.' },
    { icon: <Zap className="w-6 h-6" />, title: 'Fast Deployment', description: 'Rapid implementation with minimal disruption to operations.' },
    { icon: <Shield className="w-6 h-6" />, title: 'Enterprise Security', description: 'Bank-level security and compliance standards for all solutions.' },
    { icon: <Shield className="w-6 h-6" />, title: 'ISO Certified', description: 'We are ISO 9001:2015 certified - 100% Authenticated and Verified.' },
  ];
