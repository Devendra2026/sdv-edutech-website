...
function Gis() {
  ...
  return (
    <>
      <path
        d='M30 60 L110 38 L170 72 L130 130 L55 138 Z'
        fill='currentColor'
        fillOpacity='0.14'
        stroke='currentColor'
        strokeOpacity='0.4'
      ...
      />
      <path
        d='M160 110 L270 86 L300 160 L210 178 Z'
        fill='var(--secondary)'
        fillOpacity='0.12'
      ...
      <path
        ...
        d='M90 70 C140 92, 150 120, 200 110 S260 150, 280 150'
        fill='none'
        stroke='currentColor'
        strokeWidth='2.5'
        strokeLinecap='round'
...
function Software() {
  ...
  return (
    <>
      ...
      <circle cx='48' cy='46' r='3' fill='var(--secondary)' />
      <circle cx='60' cy='46' r='3' fill='var(--warning)' />
      <circle cx='72' cy='46' r='3' fill='var(--success)' />
      {rows.map((r, i) => (
        <g key={`row-${74 + i * 17}`} transform={`translate(50 ${74 + i * 17})`}>
          {r.map((w, j) => {
            ...
            return (
              <motion.rect
                ...
                height='7'
                rx='3.5'
                fill={j === 0 ? 'var(--secondary)' : 'currentColor'}
                fillOpacity={j === 0 ? 0.7 : 0.4}
                initial={{ width: 0 }}
                whileInView={{ width: w }}
                viewport={{ once: true }}
...
function Survey() {
  ...
  return (
    <>
      <motion.path
        d='M30 120 L80 96 L130 104 L180 70 L230 82 L290 50'
        fill='none'
        stroke='currentColor'
        strokeWidth='2.5'
        strokeLinecap='round'
    ...
    <>
      ...
      {nodes.map((n, i) => (
        <motion.circle
          ...
          animate={{ cx: [c.x, n.x], cy: [c.y, n.y], opacity: [0, 1, 0] }}
...
function Training() {
  return (
    <>
      ...
      />
      <motion.path
        d='M160 60 L235 92 L160 124 L85 92 Z'
        fill='currentColor'
        fillOpacity='0.18'
        stroke='currentColor'
        strokeOpacity='0.5'
      ...
      <path
        d='M120 124 L120 138 Q160 152 200 138 L200 124'
        fill='none'
        stroke='currentColor'
        strokeOpacity='0.4'
        strokeWidth='1.5'
...
function Consulting() {
  return (
    <>
      ...
      <circle cx='226' cy='74' r='4' fill='currentColor' />
      <circle cx='210' cy='150' r='4' fill='var(--secondary)' />
    </>
  )
}
